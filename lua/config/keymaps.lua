...
vim.keymap.set({ "n" }, cmd("e"), keyfns.focus_tree, { desc = "Switch focus to tree" })
vim.keymap.set({ "i", "v" }, cmd("e"), "<esc>" .. cmd("e"), { desc = "Switch focus to tree", remap = true })
vim.keymap.set({ "n" }, cmd("r"), keyfns.focus_buffer, { desc = "Switch focus to buffers" })
...
vim.keymap.set("n", cmd(";"), keyfns.select_function, { desc = "Select function" })
vim.keymap.set("v", cmd(";"), keyfns.goto_function_end, { desc = "Select next function" })
...
vim.keymap.set({ "n", "v" }, "<leader>l", vim.lsp.buf.hover, { desc = "LSP hover info" })
